// FILE: deque.h
//
// Group #7: Jordan Murtiff and Jackson Tseng
//
...
namespace coen79_lab8
{
    ...
    void deque<Item>::clear () {
        ...
        // Clear the data blocks
        for(size_type block_item_index = 0; block_item_index < bp_array_size; ++block_item_index) {
            delete [] block_pointers[block_item_index];
			block_pointers[block_item_index] = NULL;
        }
        first_bp = last_bp = NULL;
        front_ptr = back_ptr = NULL;
